...
export const addPoll = async (req: PollRequest, res: Response) => {
    ...
    try {
        await dbHelper.exec('AddPoll', { id, title, question, totalVotes: 0, creationTime });
...
export const getPolls = async (req: Request, res: Response) => {
    try {
        ...
        let polls = pollsResult.recordset;
        ...
        // Sort polls by creation time
        pollsWithOptions.sort((a, b) => new Date(b.creationTime).getTime() - new Date(a.creationTime).getTime());
